                            ...
                            <div className="space-y-8">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">support@gethelpi.com</p>
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">+61 3 9000 0000</p>
                                        <p className="text-sm text-gray-500 mt-1">Monday - Friday, 9 AM - 6 PM AEST</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">Serving all of Australia</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">Emergency support available anytime</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="bg-gray-50 rounded-2xl p-8 lg:p-10 shadow-lg border border-gray-100">
                                ...
                                <form className="space-y-6">
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full bg-[#511076] hover:bg-[#6b2a8f] text-white font-semibold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-purple-200"
                                    >
                                        Send Message
                                    </button>
                                </form>
